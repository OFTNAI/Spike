...
void Plotter::plot_single_cell_information_analysis(SpikeAnalyser * spike_analyser_for_untrained_network, SpikeAnalyser * spike_analyser_for_trained_network) {
	...
	printf("spike_analyser_for_untrained_network->number_of_neurons_in_single_cell_analysis_group: %d\n", spike_analyser_for_untrained_network->number_of_neurons_in_single_cell_analysis_group);
	printf("spike_analyser_for_trained_network->number_of_neurons_in_single_cell_analysis_group: %d\n", spike_analyser_for_trained_network->number_of_neurons_in_single_cell_analysis_group);
	...
	for (int neuron_index_zeroed = 0; neuron_index_zeroed < spike_analyser_for_untrained_network->number_of_neurons_in_single_cell_analysis_group; neuron_index_zeroed++) {
		...
		dataUNTRAINED.a[neuron_index_zeroed] = 0.0;
