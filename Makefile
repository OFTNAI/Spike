...
${FILE}: ${FILE}.o Simulator.o Neurons.o Connections.o NeuronPopulations.o CUDAcode.o NeuronDynamics.o STDPDynamics.o
	$(CC) ${FILE}.o Simulator.o Neurons.o Connections.o NeuronPopulations.o CUDAcode.o NeuronDynamics.o STDPDynamics.o -o ${FILE}
...
# Test script
test: Simulator.o Neurons.o Connections.o NeuronPopulations.o CUDAcode.o NeuronDynamics.o STDPDynamics.o
	$(CC) Tests.cu Simulator.o Neurons.o Connections.o NeuronPopulations.o CUDAcode.o NeuronDynamics.o STDPDynamics.o -o unittests
cleantest:
	rm *.o unittests
