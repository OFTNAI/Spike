cd('/Users/dev/Documents/Spike_aki/Spike2_trans/output/test')
...
ylim([-0.1,1.1])
xlim([1,135500+100])
hFig = breakxaxis([500 135500-300]);
ylabel('Information [bit]');
...
ylim([-0.1,1.1])
xlim([1,516500+100])
hFig = breakxaxis([500 516500-300]);
ylabel('Information [bit]');
xlabel('Spike-Pair Rank');
...
ylim([-0.1,1.1])
xlim([1,736800+100])
hFig = breakxaxis([500 736800-300]);
ylabel('Information [bit]');
xlabel('Spike-Pair Rank');
...
ylim([-0.1,1.1]);
xlim([1,687700+100])
hFig = breakxaxis([500 687700-300]);
ylabel('Information [bit]');
xlabel('Spike-Pair Rank');
