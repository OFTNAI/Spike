...
int main (int argc, char *argv[]){
	...
	simulator.AddConnectionGroup(test_neuron_group_1_id, test_neuron_group_2_id, CONNECTIVITY_TYPE_SINGLE, test_weight_range, test_delay_range, stdp_on, 3.0, 8.0);
