cd('/Users/dev/Documents/Spike_aki/Spike2_trans/output/6.3grayAndBlack_a--StatDec_FFLATFB_20EP_testMulti_FB5_rand123')
...
ylim([-0.1,1.1])
xlim([1,145200+200])
hFig = breakxaxis([500 145200-200]);
ylabel('Information [bit]');
...
ylim([-0.1,1.1])
xlim([1,500100+200])
hFig = breakxaxis([500 500100-200]);
ylabel('Information [bit]');
xlabel('Spike-Pair Rank');
...
ylim([-0.1,1.1])
xlim([1,669800+200])
hFig = breakxaxis([500 669800-200]);
ylabel('Information [bit]');
xlabel('Spike-Pair Rank');
...
ylim([-0.1,1.1]);
xlim([1,731200+200])
hFig = breakxaxis([500 731200-200]);
ylabel('Information [bit]');
xlabel('Spike-Pair Rank');
