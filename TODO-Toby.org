...
:END:
*** PROGRESS Check merge diff
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2016-12-18 Sun 21:55]
:END:
*** TODO Mark complete merge in git using `ours' strategy
...
:END:
** TODO Fix bugs exposed by TSCSOptimiseFourLayerVisionSpikingModelFiringRates
*** TODO Segfault on freeing ConductanceSpikingSynapses after 1st epoch
*** TODO Check [correctness of] reinitialisation of RandomStatesManager at Synapse prepare_backend
** TODO Get tests working again
** TODO Integrate Nas' documentation work
*** TODO Describe backend work in the docs
** TODO Example repository and build scripts with submodule structure
