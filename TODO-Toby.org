...
** PROGRESS Remove `d_' from pointer names in CUDA backend classes ...
:LOGBOOK:
...
** TODO Ensure dynamic dispatch is used as sparingly as possible
+ don't want RTTI and performance penality!
** TODO Add `override' specifier to derived versions of virtual functions
*** TODO remove `virtual' keyword where unnecessary
*** TODO remove duplicate definitions of virtual functions
