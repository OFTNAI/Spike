...
:END:
** PROGRESS Fix bugs exposed by TSCSOptimiseFourLayerVisionSpikingModelFiringRates
:LOGBOOK:
...
- State "DONE"       from "TODO"       [2016-12-20 Tue 21:35] \\
  Good enough for now!
:END:
*** TODO Investigate and fix memory leaks...
*** PROGRESS No spikes !!!
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2016-12-21 Wed 10:25]
:END:
** TODO Check cudaMemcpy calls for correctness again ...
** TODO Check Context params
