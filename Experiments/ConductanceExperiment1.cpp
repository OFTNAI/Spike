...
int main (int argc, char *argv[]){
	...
	E2I_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->stdp_on = true;
	...
	I2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->gaussian_synapses_per_postsynaptic_neuron = 20;
	...
	I2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->stdp_on = true;
	...
	I2I_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->stdp_on = true;
	...
	//
	simulator.AddSynapseGroupsForNeuronGroupAndEachInputGroup(EXCITATORY_NEURONS_LAYER_1, INPUT_TO_EXCITATORY_DELAY_RANGE, E2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS, CONNECTIVITY_STANDARD_DEVIATION_SIGMA);
	...
	simulator.AddSynapseGroup(EXCITATORY_NEURONS_LAYER_1, INHIBITORY_NEURONS_LAYER_1, EXCITATORY_TO_INHIBITORY_DELAY_RANGE, E2I_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS, CONNECTIVITY_STANDARD_DEVIATION_SIGMA);
