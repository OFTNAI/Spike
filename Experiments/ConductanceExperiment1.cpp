...
int main (int argc, char *argv[]){
	...
	E2I_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->biological_conductance_scaling_constant_lambda = 2.8 * pow(10, -3);
	...
	I2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->biological_conductance_scaling_constant_lambda = 2.07 * pow(10, -3);
	...
	//
	simulator.AddSynapseGroupsForNeuronGroupAndEachInputGroup(EXCITATORY_NEURONS_LAYER_1, INPUT_TO_EXCITATORY_DELAY_RANGE, E2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS);
