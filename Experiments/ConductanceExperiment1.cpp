...
int main (int argc, char *argv[]){
	...
	//
	simulator.AddSynapseGroupsForNeuronGroupAndEachInputGroup(EXCITATORY_NEURONS_LAYER_1, CONNECTIVITY_TYPE_GAUSSIAN_SAMPLE, INPUT_TO_EXCITATORY_DELAY_RANGE, true, E2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS, CONNECTIVITY_STANDARD_DEVIATION_SIGMA);
	...
	simulator.AddSynapseGroup(EXCITATORY_NEURONS_LAYER_1, INHIBITORY_NEURONS_LAYER_1, CONNECTIVITY_TYPE_GAUSSIAN_SAMPLE, EXCITATORY_TO_INHIBITORY_DELAY_RANGE, false, E2I_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS, CONNECTIVITY_STANDARD_DEVIATION_SIGMA);
