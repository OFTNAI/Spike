...
int main (int argc, char *argv[]){
	...
	E2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->biological_conductance_scaling_constant_lambda = 5.0 * pow(10, -6);
	...
	E2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->gaussian_synapses_per_postsynaptic_neuron = 30;
	E2I_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->biological_conductance_scaling_constant_lambda = 2.3 * pow(10, -2);
	...
	E2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->gaussian_synapses_per_postsynaptic_neuron = 20;
	I2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS->biological_conductance_scaling_constant_lambda = 2.0 * pow(10, -2);
	...
	//
	simulator.AddSynapseGroupsForNeuronGroupAndEachInputGroup(EXCITATORY_NEURONS_LAYER_1, CONNECTIVITY_TYPE_GAUSSIAN_SAMPLE, INPUT_TO_EXCITATORY_WEIGHT_RANGE, INPUT_TO_EXCITATORY_DELAY_RANGE, true, E2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS, CONNECTIVITY_STANDARD_DEVIATION_SIGMA);
	...
	simulator.AddSynapseGroup(EXCITATORY_NEURONS_LAYER_1, INHIBITORY_NEURONS_LAYER_1, CONNECTIVITY_TYPE_GAUSSIAN_SAMPLE, EXCITATORY_TO_INHIBITORY_WEIGHT_RANGE, EXCITATORY_TO_INHIBITORY_DELAY_RANGE, false, E2I_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS, CONNECTIVITY_STANDARD_DEVIATION_SIGMA);
	...
	// simulator.AddSynapseGroup(INHIBITORY_NEURONS_LAYER_1, EXCITATORY_NEURONS_LAYER_1, CONNECTIVITY_TYPE_GAUSSIAN_SAMPLE, INHIBITORY_TO_EXCITATORY_WEIGHT_RANGE, INHIBITORY_TO_EXCITATORY_DELAY_RANGE, false, I2E_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS, CONNECTIVITY_STANDARD_DEVIATION_SIGMA);
	...
	// simulator.AddSynapseGroup(INHIBITORY_NEURONS_LAYER_1, INHIBITORY_NEURONS_LAYER_1, CONNECTIVITY_TYPE_GAUSSIAN_SAMPLE, INHIBITORY_TO_EXCITATORY_WEIGHT_RANGE, INHIBITORY_TO_EXCITATORY_DELAY_RANGE, false, I2I_CONDUCTANCE_SPIKING_SYNAPSE_PARAMETERS, CONNECTIVITY_STANDARD_DEVIATION_SIGMA);
