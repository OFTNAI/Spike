...
// NetworkArchiver Constructor
NetworkArchiver::NetworkArchiver(SpikingNeurons * neurons_parameter, SpikingSynapses * spiking_synapses, string full_directory_name_for_simulation_data_files_param, const char * prefix_string_param) {
...
// NetworkArchiver Destructor
NetworkArchiver::~NetworkArchiver() {


}


void NetworkArchiver::write_initial_synaptic_weights_to_file(SpikingSynapses *synapses, bool human_readable_storage) {
...
void NetworkArchiver::write_network_state_to_file(SpikingSynapses *synapses, bool human_readable_storage) {
